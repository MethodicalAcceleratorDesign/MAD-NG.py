...
with MAD(debug=False) as mad:
    ...
    mad.MADX.method(
        "load", None, f"'{filepath}ps_mu.seq'", f"'{filepath}ps_mu.mad'", False
    )
    mad.MADX.method(
        "load", None, f"'{filepath}ps_ss.seq'", f"'{filepath}ps_ss.mad'", False
    )
    mad.MADX.method(
        "load", None, f"'{filepath}ps_fb_lhc.str'", f"'{filepath}ps_fb_lhc_str.mad'", False,
    )
    ...
    mad.srv.method("write", None, "'PS_survey_py.tfs'",
